...
const input = {
  ...
  "components/icon/icons/av/index": "./src/components/icon/icons/av/index",
  "components/icon/icons/communication/index": "./src/components/icon/icons/communication/index",
  "components/icon/icons/content/index": "./src/components/icon/icons/content/index",
  "components/icon/icons/device/index": "./src/components/icon/icons/device/index",
  "components/icon/icons/editor/index": "./src/components/icon/icons/editor/index",
  "components/icon/icons/file/index": "./src/components/icon/icons/file/index",
  "components/icon/icons/hardware/index": "./src/components/icon/icons/hardware/index",
  "components/icon/icons/home/index": "./src/components/icon/icons/home/index",
  "components/icon/icons/image/index": "./src/components/icon/icons/image/index",
  "components/icon/icons/maps/index": "./src/components/icon/icons/maps/index",
  ...
  "components/icon/icons/notification/index": "./src/components/icon/icons/notification/index",
  "components/icon/icons/places/index": "./src/components/icon/icons/places/index",
  "components/icon/icons/search/index": "./src/components/icon/icons/search/index",
  "components/icon/icons/social/index": "./src/components/icon/icons/social/index",
