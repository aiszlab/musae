  ...
  return (
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        />
        <path
          d="M11.5 7.5V6C11.5 5.45 11.05 5 10.5 5H8.5V4H11.5V2.5H7V6H10V7H7V8.5H10.5C11.05 8.5 11.5 8.05 11.5 7.5Z"
          fill="currentColor"
        />
      </g>
    </svg>
