  ...
  return (
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        />
        <path
          d="M8 8.5H10.5C11.05 8.5 11.5 8.05 11.5 7.5V6C11.5 5.45 11.05 5 10.5 5H8.5V4H11.5V2.5H8C7.45 2.5 7 2.95 7 3.5V7.5C7 8.05 7.45 8.5 8 8.5ZM8.5 6H10V7.5H8.5V6Z"
          fill="currentColor"
        />
      </g>
    </svg>
