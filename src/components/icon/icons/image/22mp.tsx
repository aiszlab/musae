...
const TwentyTwoMp = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        />
        <path
          d="M14.5 7H11.5V6H13.5C14.05 6 14.5 5.55 14.5 5V3.5C14.5 2.95 14.05 2.5 13.5 2.5H10V4H13V5H11C10.45 5 10 5.45 10 6V8.5H14.5V7Z"
          fill="currentColor"
        />
      </g>
    </svg>
