...
const IconBrightness7 = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g clipPath="url(#clip0_2403_5080)">
        ...
        />
        <path
          d="M12 14.0004C13.1046 14.0004 14 13.105 14 12.0004C14 10.8959 13.1046 10.0004 12 10.0004C10.8954 10.0004 10 10.8959 10 12.0004C10 13.105 10.8954 14.0004 12 14.0004Z"
          fill="currentColor"
        />
      </g>
      <defs>
