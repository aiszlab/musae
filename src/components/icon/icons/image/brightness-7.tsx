...
const Brightness7 = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.061)">
        ...
        />
        <path
          d="M11.31 13.31C12.4146 13.31 13.31 12.4146 13.31 11.31C13.31 10.2054 12.4146 9.31 11.31 9.31C10.2054 9.31 9.31 10.2054 9.31 11.31C9.31 12.4146 10.2054 13.31 11.31 13.31Z"
          fill="currentColor"
        />
      </g>
    </svg>
