  ...
  return (
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        <path
          d="M13.5 7.5V6C13.5 5.45 13.05 5 12.5 5H10.5V4H13.5V2.5H9V6H12V7H9V8.5H12.5C13.05 8.5 13.5 8.05 13.5 7.5Z"
          fill="currentColor"
        />
      </g>
    </svg>
