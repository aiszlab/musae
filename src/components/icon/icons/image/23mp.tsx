...
const TwentyThreeMp = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        />
        <path
          d="M14.5 7.5V3.5C14.5 2.95 14.05 2.5 13.5 2.5H10V4H13V5H11V6H13V7H10V8.5H13.5C14.05 8.5 14.5 8.05 14.5 7.5Z"
          fill="currentColor"
        />
      </g>
    </svg>
