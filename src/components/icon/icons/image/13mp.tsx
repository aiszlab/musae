...
const ThirteenMp = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        <path
          d="M13.5 7.5V3.5C13.5 2.95 13.05 2.5 12.5 2.5H9V4H12V5H10V6H12V7H9V8.5H12.5C13.05 8.5 13.5 8.05 13.5 7.5Z"
          fill="currentColor"
        />
        <path
