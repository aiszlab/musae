...
const EighteenMp = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        <path
          d="M10 8.5H12.5C13.05 8.5 13.5 8.05 13.5 7.5V3.5C13.5 2.95 13.05 2.5 12.5 2.5H10C9.45 2.5 9 2.95 9 3.5V7.5C9 8.05 9.45 8.5 10 8.5ZM10.5 3.5H12V5H10.5V3.5ZM10.5 6H12V7.5H10.5V6Z"
          fill="currentColor"
        />
      </g>
    </svg>
