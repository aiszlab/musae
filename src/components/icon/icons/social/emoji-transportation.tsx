...
const IconEmojiTransportation = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <path
        ...
        fill="currentColor"
      />
      <path d="M14 9H15V3H7V8H2V21H3V9H8V4H14V9Z" fill="currentColor" />
      <path d="M7 11H5V13H7V11Z" fill="currentColor" />
      <path d="M12 5H10V7H12V5Z" fill="currentColor" />
      <path d="M7 15H5V17H7V15Z" fill="currentColor" />
      <path d="M7 19H5V21H7V19Z" fill="currentColor" />
    </svg>
  );
});

export default IconEmojiTransportation;
