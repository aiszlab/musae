...
const IconGroups2 = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <path
        d="M10.27 12H13.73C14.66 12 15.36 11.17 15.21 10.25L14.91 8.46C14.67 7.04 13.44 6 12 6C10.56 6 9.33 7.04 9.09 8.47L8.79 10.26C8.64 11.17 9.34 12 10.27 12ZM11.06 8.79C11.14 8.33 11.53 8 12 8C12.47 8 12.86 8.33 12.94 8.79L13.14 10H10.86L11.06 8.79Z"
        fill="currentColor"
      />
      <path
