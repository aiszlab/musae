  ...
  return (
    ...
    >
      <g transform="translate(0, 2.7273) scale(1.0909)">
        ...
        />
        <path
          d="M12 7.99V9.65C13.13 9.01 14.7 8.66 16.5 8.66C17.38 8.66 18.23 8.75 19 8.92V7.4C18.21 7.25 17.36 7.16 16.5 7.16C14.8 7.16 13.26 7.46 12 7.99Z"
          fill="currentColor"
        />
        <path
          d="M16.5 9.83C14.8 9.83 13.26 10.12 12 10.66V12.32C13.13 11.68 14.7 11.33 16.5 11.33C17.38 11.33 18.23 11.42 19 11.59V10.07C18.21 9.91 17.36 9.83 16.5 9.83Z"
          fill="currentColor"
        />
      </g>
    </svg>
