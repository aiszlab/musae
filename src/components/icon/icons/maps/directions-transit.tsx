...
const DirectionsTransit = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(1.8947, 0) scale(1.2632)">
        <path
          d="M8 0C4 0 0 0.5 0 4V13.5C0 15.43 1.57 17 3.5 17L2 18.5V19H14V18.5L12.5 17C14.43 17 16 15.43 16 13.5V4C16 0.5 12.42 0 8 0ZM13.66 3H2.43C3.04 2.48 4.49 2 8 2C11.71 2 13.12 2.46 13.66 3ZM7 5V8H2V5H7ZM9 5H14V8H9V5ZM12.5 15H3.5C2.67 15 2 14.33 2 13.5V10H14V13.5C14 14.33 13.33 15 12.5 15Z"
          fill="currentColor"
        />
        <path
