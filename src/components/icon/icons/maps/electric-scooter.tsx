...
const IconElectricScooter = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M19.001 12C17.341 12 16.001 13.34 16.001 15C16.001 16.66 17.341 18 19.001 18C20.661 18 22.001 16.66 22.001 15C22.001 13.34 20.661 12 19.001 12ZM19.001 16C18.451 16 18.001 15.55 18.001 15C18.001 14.45 18.451 14 19.001 14C19.551 14 20.001 14.45 20.001 15C20.001 15.55 19.551 16 19.001 16Z"
        fill="currentColor"
      />
      <path d="M11.001 20H7.00103L13.001 23V21H17.001L11.001 18V20Z" fill="currentColor" />
    </svg>
  );
});

export default IconElectricScooter;
