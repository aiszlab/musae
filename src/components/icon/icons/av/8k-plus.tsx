...
const EightKPlus = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        <path
          d="M4 12H6C6.55 12 7 11.55 7 11V7C7 6.45 6.55 6 6 6H4C3.45 6 3 6.45 3 7V11C3 11.55 3.45 12 4 12ZM4.5 7H5.5V8.5H4.5V7ZM4.5 9.5H5.5V11H4.5V9.5Z"
          fill="currentColor"
        />
        <path
