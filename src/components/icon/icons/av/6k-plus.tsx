  ...
  return (
    ...
    >
      <g transform="translate(0, 0) scale(1.3333)">
        ...
        />
        <path
          d="M4 12H6C6.55 12 7 11.55 7 11V9.5C7 8.95 6.55 8.5 6 8.5H4.5V7.5H7V6H4C3.45 6 3 6.45 3 7V11C3 11.55 3.45 12 4 12ZM4.5 9.5H5.5V11H4.5V9.5Z"
          fill="currentColor"
        />
      </g>
    </svg>
