...
const IconAssuredWorkload = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        fill="currentColor"
      />
      <path d="M1 18.5V20.5H13.4C13.19 19.86 13.08 19.19 13.04 18.5H1Z" fill="currentColor" />
...
export default IconAssuredWorkload;
