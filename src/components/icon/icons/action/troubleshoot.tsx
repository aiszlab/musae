...
const IconTroubleshoot = withIcon(({ size }) => {
  return (
    <svg
    ...
    >
      ...
      />
      <path
        d="M8.93 9.19L10.15 14.5H11.79L13.05 10.72L14 13H16V11.5H15L13.75 8.5H12.21L11.09 11.87L9.85 6.5H8.2L6.95 10.5H1.5V12H8.05L8.93 9.19Z"
        fill="currentColor"
      />
    </svg>
  );
