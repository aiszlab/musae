  ...
  return (
    <label
      ...
      style={{
        ...
        "--color-primary-opacity-20": hexToRgba(theme.colors.primary, OPACITY.thicker, "style"),
        ...
        "--color-error-opacity-08": hexToRgba(theme.colors.error, OPACITY.thin, "style"),
        "--color-error-opacity-12": hexToRgba(theme.colors.error, OPACITY.medium, "style"),
        "--color-error-opacity-20": hexToRgba(theme.colors.error, OPACITY.thicker, "style"),
