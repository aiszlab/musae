    ...
    >
      {loading && (
        ...
        >
          <svg
            viewBox="0 0 240 240"
            className={clsx(classNames[LoadingClassToken.Spinning], styled.spinning.className)}
      ...
      <div
        className={clsx(classNames[LoadingClassToken.Content], className, styled.content.className)}
        style={{
